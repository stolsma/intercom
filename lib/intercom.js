 ...
 */
if (!process.parent && process.env.NODE_CHANNEL_FD) {
  // is this process a node fork child and no ipc channel available?
  if (!process.send && process.env.NODE_CHANNEL_FD) require('node-fork');
